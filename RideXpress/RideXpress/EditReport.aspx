            ...
            <div class="form-horizontal">
                    ...
                    <div class="col-xs-4">
                        ...
                        <div class="has-error">
                            <span class="help-block">
                                <asp:RequiredFieldValidator ID="RideRequired" runat="server" ErrorMessage="Ride is Required" ControlToValidate="ddlRide" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-4 col-xs-offset-4">
                        <asp:Button ID="btnEditReport" runat="server" Text="Submit" CssClass="btn btn-success" ValidationGroup="AllValidators" OnClick="btnEditReport_Click" />
